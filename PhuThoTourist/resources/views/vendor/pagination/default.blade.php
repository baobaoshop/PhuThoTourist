@if ($paginator->hasPages())
    <div class="doc_main_panigation">
        ...
        @if ($paginator->onFirstPage())
            <div class="doc_main_panigation_item disabled">
        ...
        @else
            <div class="doc_main_panigation_item">
                <a href="{{ $paginator->previousPageUrl() }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                        <path d="M13.5 15L7.5 10L13.5 5" fill="#4D4D4D"/>
                        <path d="M13.5 15L7.5 10L13.5 5L13.5 15Z" stroke="#4D4D4D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </a>
            </div>
        @endif
        ...
        @else
            <div class="doc_main_panigation_item disabled">
                <a href="javascript:void(0);">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                        <path d="M7.5 15L13.5 10L7.5 5" fill="#A3A3A3"/>
                        <path d="M7.5 15L13.5 10L7.5 5L7.5 15Z" stroke="#A3A3A3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </a>
            </div>
        @endif
