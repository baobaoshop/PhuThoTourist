        ...
        <div class="navbar_logo">
            <a href="/">
                <svg xmlns="http://www.w3.org/2000/svg" width="115" height="73" viewBox="0 0 115 73" fill="none">
                    ...
                    <path d="M41.608 24.3648L1 46.0224L35.7424 35.1936L73.1919 48.2784L114.251 26.6208L79.0575 37.9008L41.608 24.3648Z" fill="white" stroke="#0054A6" stroke-width="0.811145" stroke-linejoin="round"/>
                </svg>
            </a>
        </div>
        <div class="navbar_text">
...
<div class="navigation navigation__mobile">
    ...
    <div class="navbar_menu navbar_menu__mobile" id="menu">
        <button class="close" id="closeBtn"><i class="fa-solid fa-xmark"></i></button>
        <div class="navbar_item navbar_item__mobile">
            <div class="navbar_text"><a href="/">Trang chủ</a></div>
            <div class="navbar_text"><a href="/blog">Bài viết</a></div>
            <div class="navbar_text"><a href="/documents">Tài liệu</a></div>
            <div class="navbar_text"><a href="/recruitment">Tuyển dụng</a></div>
        </div>
    </div>
</div>
