<div class="footer ">
    <div class="footer_item1">
        <div class="footer_item1_logo">
            ...
            <div class="footer_item1_company_title">
                <div class="footer_item1_company_name">CÔNG TY CỔ PHẦN DỊCH VỤ DU LỊCH PHÚ THỌ</div>
                <div class="footer_item1_company_nickname">PHUTHOTOURIST</div>
            </div>
        </div>
        <div class="footer_item1_subtitle">Copyright &copy; Công ty Cổ phần Dịch vụ Du lịch Phú Thọ (Phuthotourist)</div>
    </div>
    <div class="footer_item2">
        <div class="footer_item2_title">LIÊN HỆ</div>
        <div class="footer_item2_content">
            <div class="footer_item2_content_item">
                <div class="footer_item2_content_item_logo">
                ...
                <div class="footer_item2_content_item_title">15 Đường số 2, Cư xá Lữ Gia,<br/> Phường 15, Quận 11, TP. HCM</div>
            </div>
            <div class="footer_item2_content_item">
                <div class="footer_item2_content_item_logo">
                ...
                <div class="footer_item2_content_item_title">02838650921</div>
            </div>
            <div class="footer_item2_content_item">
                <div class="footer_item2_content_item_logo">
                ...
                <div class="footer_item2_content_item_title">vanphong</div>
            </div>
            <div class="footer_item2_content_item">
                <div class="footer_item2_content_item_logo">
                ...
                <div class="footer_item2_content_item_title">Phuthotourist</div>
            </div>
        </div>
    </div>
    <div class="footer_item3">
        <div class="footer_item3_title">CÁC ĐƠN VỊ CÙNG HỆ THỐNG PHUTHOTOURIST</div>
        <div class="footer_item3_content">
            <div class="footer_item3_content_item">
                <div class="footer_item3_content_item_icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="6" height="7" viewBox="0 0 6 7" fill="none">
                        <circle cx="3" cy="3.5" r="3" fill="white"/>
                    </svg>
                </div>
                <div class="footer_item3_content_item_title">Công viên Văn hóa Đầm Sen</div>
            </div>
            <div class="footer_item3_content_item">
                <div class="footer_item3_content_item_icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="6" height="7" viewBox="0 0 6 7" fill="none">
                ...
                <div class="footer_item3_content_item_title">Khu du lịch sinh thái Vàm Sát</div>
            </div>
            <div class="footer_item3_content_item">
                <div class="footer_item3_content_item_icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="6" height="7" viewBox="0 0 6 7" fill="none">
                ...
                <div class="footer_item3_content_item_title">Khách sạn Ngọc Lan (Quận 1)</div>
            </div>
            <div class="footer_item3_content_item">
                <div class="footer_item3_content_item_icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="6" height="7" viewBox="0 0 6 7" fill="none">
                ...
                <div class="footer_item3_content_item_title">Khách sạn Phú Thọ (Quận 11)</div>
            </div>
            <div class="footer_item3_content_item">
                <div class="footer_item3_content_item_icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="6" height="7" viewBox="0 0 6 7" fill="none">
                ...
                <div class="footer_item3_content_item_title">Trung tâm Du lịch Đầm Sen</div>
            </div>
        </div>
    </div>
</div>
